...
public class HttpTest {
    ...
    public static void main1(String destNumber,String sign,String content ) {
        String url = "http://39.105.92.229:8085/api/sms/submit";//测试环境
        Map<String, String> header = new HashMap<>();
        header.put("Content-Type", "application/json;charset=utf-8");
        header.put("Accept", "application/json");
        String charset = "UTF-8";
         String accessKey = "4x963e1v7iFIk4p2";
        String secretKey = "wU74aZeHYuh8qKeq57fumAWniME0UlZXp8igNZONJ9iQDKOGrxVcbqM8mJCbDHjT";
        for (int i = 0; i < 1; i++) {
